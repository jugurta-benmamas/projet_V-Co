...
{
    public partial class Form_GererModulesFormateur : Form
    {
        private MySqlConnection laConnection; // La connexion à la base de données
        private Panel menuPanel;

        public Form_GererModulesFormateur()
        {
            InitializeComponent();
        ...
        {
            // Cache le formulaire actuel et retourne au tableau de bord pour le formateur
            this.Hide();
            Form_TableauBordFormateur formTableauBordForm = new Form_TableauBordFormateur();
            formTableauBordForm.Closed += (s, args) => this.Close();
            formTableauBordForm.Show();
