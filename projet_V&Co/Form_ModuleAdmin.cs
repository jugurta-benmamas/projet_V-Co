...
{
    public partial class Form_ModuleAdmin : Form
    {
        ...
        public Form_ModuleAdmin(module module)
        {
            InitializeComponent();
        ...
        private void PictureBox_Click(object sender, EventArgs e)
        {
            ...
            if (pictureBox != null && pictureBox.Tag is cours cours)
            {
                ...
                this.Hide();
                Form_CoursAdmin formCoursAdmin = new Form_CoursAdmin(cours);
                formCoursAdmin.Closed += (s, args) => this.Close();
                formCoursAdmin.Show();
            }
        }
